...
![Terminal vs VS Code side by side](../assets/images/terminal-vscode.png)
...
![Git Windows installer](../assets/images/git-install-windows.png)
...
![VS Code Source Control sidebar](../assets/images/git-vscode-sidebar.png)
...
![Git flow diagram](../assets/images/git-flow-diagram.svg)
...
![Git clone in terminal](../assets/images/git-clone-terminal.png)
...
![Git status output](../assets/images/git-status-terminal.png)
...
![Git add and commit](../assets/images/git-add-commit-terminal.png)
...
![Git push output](../assets/images/git-push-terminal.png)
...
![Git branch list](../assets/images/git-branch-terminal.png)
...
![Git log output](../assets/images/git-log-terminal.png)
...
![VS Code Source Control panel](../assets/images/git-vscode-source.png)
...
![VS Code diff view](../assets/images/git-vscode-diff.png)
...
![VS Code staging a file](../assets/images/git-vscode-stage.png)
...
![VS Code commit message](../assets/images/git-vscode-commit.png)
...
![VS Code push pull bar](../assets/images/git-vscode-push-pull.png)
...
![VS Code branch switcher lead](../assets/images/git-vscode-branch-switcher-lead.png)
![VS Code branch switcher](../assets/images/git-vscode-branch-switcher.png)
...
![VS Code integrated terminal](../assets/images/git-vscode-terminal.png)
